...
# -*- coding: utf-8 -*-
"""
Created on Sat Feb 17 18:38:42 2024
...
# Initialisation du modèle GBM pour la régression
...
plt.ylabel('Classe')
plt.title('Gradient Boosting Machines (GBM) pour la régression sur les données Iris')
plt.show()
