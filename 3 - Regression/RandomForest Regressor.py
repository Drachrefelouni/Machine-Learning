...
# -*- coding: utf-8 -*-
"""
Created on Sat Feb 17 18:37:43 2024
...
# Initialisation du modèle de forêt aléatoire pour la régression
...
plt.ylabel('Classe')
plt.title('Forêt aléatoire pour la régression sur les données Iris')
plt.show()
