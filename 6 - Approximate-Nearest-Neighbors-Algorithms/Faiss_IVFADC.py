...
# -*- coding: utf-8 -*-
"""
Created on Mon Nov 27 18:12:01 2023
...
m = 8  # Paramètre m pour IVFADC

# Construction de l'index IVFADC avec FAISS
index = faiss.index_factory(d, "IVFADC{m=%d}" % m, faiss.METRIC_L2)
index.train(data)
index.add(data)
